...
export default function FormOAuth() {
    ...
    const handleClick = (e: JSXInternal.TargetedEvent<HTMLButtonElement, Event>) => {
        ...
        fetch("/api/v1/auth/login", {
            ...
            body: JSON.stringify({ provider: e.currentTarget.value }),
    ...
    return <form
        aria-label="login by SSRR "
        onSubmit={(e)=> e.preventDefault}
        action=""
        method="post"
        class="mt-6 flex flex-wrap sm:grid gap-6 grid-cols-2"
    >
        <button
            disabled
            class="cursor-not-allowed
w-full h-11 rounded-full border border-gray-300/75 bg-white px-6 transition active:bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:hover:bg-gray-800 dark:hover:border-gray-700"
        >
            <div
        ...
        >
            ...
            >
                ...
                <span
                    class="block w-max text-sm font-semibold tracking-wide text-white">With Github </span >
            </div>
        </button>
    </form>
